 ...
 * ==================================================================
 * 
 * Filename: pmdOptions.cpp
 * 
 * Created: 11/02/2020 18:03 PM
 * 
 * Author: Yuan Haizhuo
 * 
 * ==================================================================
...
// constructor, all params inited by zero.
...
int pmdOptions::readConfigureFile(const char *path, po::options_description &desc, po::variables_map &vm)
{
  int rc = EDB_OK;
...
int pmdOptions::init(int argc, char **argv)
{
  ...
  po::variables_map vm;  // 从命令行来的
  po::variables_map vm2; // 从文件来的
